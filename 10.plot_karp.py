...
for i in range(len(grid_configs)):
    ...
    plt.plot(df_n['NUM_THREADS'], df_n['Karp-Flatt Metric'], marker='o', label=f'Case {i+1}')


# Add labels and title
plt.title('Karp-Flatt Metric vs. Number of Threads', fontsize=14)
plt.xlabel('Number of Threads', fontsize=12)
plt.ylabel('Karp-Flatt Metric', fontsize=12)
...
# Save the plot
plt.savefig('./Images/karp_vs_threads.png', dpi=300)
